...
/*	*******************************************************************************     */
/*	April 2021:																			*/
/*	Added Library to auto-versioning of GI.bench build process.              			*/
/*	First version started with															*/
/*																						*/
/*   V1.9.0 build 483 (work)															*/
/*																						*/
/*																						*/
/*  November 2021:																		*/
/*  Added _CD_eGateHighSpeedPort_ReadBufferToByteArray									*/	
/*																						*/
//////////////////////////////////////////////////////////////////////////////////////////
/*--------------------------------------------------------------------------------------*/
...
#define CHINFO_INOFFSET			35	// = Input Byte Offset
...
#define DEVICE_DATAFRAMEWIDTH	54
#define DEVICE_ENDIANNESS		55
#define DEVICE_FRAMELENGTH_IN	56
#define DEVICE_FRAMELENGTH_OUT	57
...
/************		Read buffer to double array									
	...
	Time range to be read can be limited with ReadBuffer_SetTimeRange.
	...
	RETURN:
		General return codes, Success if HSP_OK or HSP_COMPLETE
*/
EGATEHIGHSPEEDPORT_API 
int32_t CALLINGCONVENTION_CD 
...
EGATEHIGHSPEEDPORT_API
int32_t CALLINGCONVENTION_CD
_CD_eGateHighSpeedPort_ReadBufferToByteArray(int32_t ConnectionInstance,
											char* buffer,
											uint32_t bufferSize,
											uint32_t fillBuffer,
											uint32_t* receivedFrames,
...
EGATEHIGHSPEEDPORT_API
int32_t CALLINGCONVENTION_SC
SC_eGateHighSpeedPort_ReadBufferToByteArray(int32_t ConnectionInstance,
											char* buffer,
											uint32_t bufferSize,
											uint32_t fillBuffer,
											uint32_t* receivedFrames,
...
EGATEHIGHSPEEDPORT_API
int32_t CALLINGCONVENTION_CD
_CD_eGateHighSpeedPort_ReadBuffer_SetTimeRange(int32_t ConnectionInstance,
											   uint64_t StartTimeDC,
											   uint64_t EndTimeDC);

EGATEHIGHSPEEDPORT_API
int32_t CALLINGCONVENTION_SC
SC_eGateHighSpeedPort_ReadBuffer_SetTimeRange(int32_t ConnectionInstance,
											  uint64_t StartTimeDC,
											  uint64_t EndTimeDC);
...
*/
EGATEHIGHSPEEDPORT_API
int32_t CALLINGCONVENTION_CD _CD_eGateHighSpeedPort_GetLastErrorMessage(int32_t connectionInstance,
																		char* 		errorMsg,
																		uint32_t	errorMsgLen);
EGATEHIGHSPEEDPORT_API
int32_t CALLINGCONVENTION_SC SC_eGateHighSpeedPort_GetLastErrorMessage(int32_t connectionInstance,
																		char* 		errorMsg,
																		uint32_t	errorMsgLen);
/*--------------------------------------------------------------------------------------*/
/************		Get debug message												
...
/*****************************************
* * -------------------------------------------------------------------------------------------
* robert test for find controller
* Gantenr Instruments Beijing Office
* -------------------------------------------------------------------------------------------
*/
// First reading...
EGATEHIGHSPEEDPORT_API
int32_t _CDDLG_IdentifyDevices_First(int32_t ExtCommand, int64_t ScanTime, char* AdapterInfo, char* DeviceInfo, char* ErrorString);

// Next reading...
EGATEHIGHSPEEDPORT_API
int32_t _CDDLG_IdentifyDevices_Next(char* AdapterInfo, char* DeviceInfo, char* ErrorString);
